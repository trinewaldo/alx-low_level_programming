...
[4. realloc](void *_realloc(void *ptr, unsigned int old_size, unsigned int new_size))
...
[5. We must accept finite disappointment, but never lose infinite hope](mul num1 num2)
